...
Es gibt keine Stromdichte, somit gilt überall $\vec j = 0$. Daraus für $H$:
\[
	\vnabla \times \vec H = \vec j = 0
\]

Somit ist $\vec H$ rotationsfrei und kann als Gradient geschrieben werden. Da
allerdings auch $\divergence{\vec H} = 0$, somit löst $\vec H$ die
Laplacegleichung.

...
\begin{equation}
	...
	\norm{\tens x} = 0
	\iff
	c^2 \del{x^0}^2 - \del{x^1}^2 - \del{x^2}^2 - \del{x^3}^2
	\iff
	c^2 t^2 = x^2 + y^2 + z^2
\end{equation}
...
\begin{subequations}
	...
	\begin{align}
		x' &= - v f\del{v^2} t +   f\del{v^2} x \\
		t' &=     g\del{v^2} t - v h\del{v^2} x \\
	\end{align}
\end{subequations}
...
\begin{align*}
	c^2 t'^2 &= x'^2 + y'^2 + z'^2 \\
	c^2 \del{g\del{v^2} t - v h\del{v^2} x}^2 &= \del{- v f\del{v^2} t +   f\del{v^2} x}^2 + y^2 + z^2 \\
...
Wir schreiben die Hin- und Rücktransformation als Matrix:
\[
	\tens \Lambda
	=
	\begin{pmatrix}

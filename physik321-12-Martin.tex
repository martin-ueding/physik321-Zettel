...
Dabei haben wir jetzt einen weiteren Term durch die Produktregel bekommen, den
wir in der Lagrangedichte so nicht stehen haben. Das $\partial_\mu$ soll auf das $A_\nu$ wirken, wirkt jedoch auch noch auf das $A_\beta$. Dieser Summand ist dann:
\[
	\epsilon^{\mu\nu\alpha\beta} A_{\nu} \partial_{\mu} \partial_{[\alpha} A_{\beta]}
\]

Der Levi-Civita-Tensor sorgt allerdings dafür, dass der Term $\partial_{[\mu}
F_{\alpha\beta]}$ vorkommt, der nach der Bianchi-Identität gerade 0 ist.

Somit gilt die obige
Herleitung.\footnote{\url{http://physics.stackexchange.com/a/51698/5705}}

...
Wir legen die beiden $\tens F$ aufeinander und multiplizieren Punktweise und
addieren alles auf. Wir erhalten:
\[
...
Wir sollen zeigen, dass sich der obige Ausdruck als totale Divergenz eines
Vierervektors $\tens G$ schreiben lässt, also als
\[
	\partial_\mu G^\mu
\]
\begin{center}

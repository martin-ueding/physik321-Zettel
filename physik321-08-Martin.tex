...
% http://compact.nussnet.at/basiswissen_6/regenbogen.php

\subsection{Maximum}

Analog zur nächsten Aufgabe betrachten wir für den symmetrischen Fall, da wir
hier ein Extremum haben. Wir lesen aus der Skizze ab:
\[
...
\[
	\dod[2]{\Theta_S}{\Theta_I} = 4 \left(\frac{\sin (\Theta_I) \cos ^2(\Theta_I)}{n^3 \left(1-\frac{\sin
	^2(\Theta_I)}{n^2}\right)^{3/2}}-\frac{\sin (\Theta_I)}{n \sqrt{1-\frac{\sin ^2(\Theta_I)}{n^2}}}\right) 
\]
